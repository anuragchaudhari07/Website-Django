...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('hc_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ...
                ('o_desig', models.CharField(max_length=32, verbose_name='Complainant Designation')),
                ...
                ('comp_head', models.CharField(max_length=128, verbose_name='Company Head')),
                ('comp_state', models.CharField(max_length=32, verbose_name='Company State')),
                ('comp_city', models.CharField(max_length=32, verbose_name='Company City')),
                ('comp_adds', models.TextField(blank=True, max_length=256, null=True, verbose_name='Company Address')),
                ('acc_name', models.CharField(max_length=128, verbose_name='Accused Name')),
                ('acc_desig', models.CharField(max_length=32, verbose_name='Accused Designation')),
                ('relw_acc', models.CharField(max_length=32, verbose_name='Working Relation with Accused')),
                ('icc', models.CharField(choices=[('YES', 'YES'), ('NO', 'NO')], default='YES', max_length=4, verbose_name='Complaint filed at ICC')),
                ...
                ('c_document', models.FileField(blank=True, null=True, upload_to='harassment/', verbose_name='Complaint related documents')),
                ...
                ('admin_document', models.FileField(blank=True, null=True, upload_to='admin/harassment', verbose_name='Attach documents')),
